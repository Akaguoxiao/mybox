package com.aka.http.observer;

import com.aka.http.function.HttpResultFunction;
import com.aka.http.function.ServerResultFunction;
...
public class HttpObservable {
    ...
    private HttpObservable(Builder builder) {
        ...
        apiObservable = builder.apiObservable;
    }
