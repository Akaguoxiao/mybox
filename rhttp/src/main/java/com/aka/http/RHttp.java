...
import com.aka.http.cancel.RequestManagerImpl;
import com.aka.http.load.upload.UploadRequestBody;
import com.aka.http.observer.HttpObservable;
import com.aka.http.retrofit.Method;
...
public class RHttp {
    ...
    private RHttp(Builder builder) {
        ...
        activityEvent = builder.activityEvent;
        fragmentEvent = builder.fragmentEvent;
        tag = builder.tag;
