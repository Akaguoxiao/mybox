 ...
 */
public abstract class MvpFragmentActivity<V extends IMvpView, P extends IMvpPresenter<V>> extends
        RxFragmentActivity implements IMvpView, MvpDelegateCallback<V, P> {
